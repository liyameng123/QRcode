...
public class CreateQrcode_IDCard {
	public static void main(String[] args) throws IOException {
		...
		String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=uir:https://img01.sogoucdn.com/app/a/100520093/e222e3d1e5293cd2-85cec76a9227617a-6fdaecbe91d9e8d6fa874f5cb0013ea1.jpg\n" +
                   "FN:姓名:李雅梦\n"+
                   "TITLE:河北科技师范学院学生\n"+
                   "ADR;WORK:;;秦皇岛海港区西港镇河北大街西段360号\n"+
                   "TEL;CELL,VOICE:13780278533\n"+
                   "TEL;WORK,VOICE:15028562960\r\n"+
                   "URL;WORK:http://www.hevttc.edu.cn\n"+
                   "EMAIL;INTERNET,HOME:1565140635@qq.com\n"+
                   "END:VCARD";//二维码扫出来的内容
        //得到一个二维数组
        ...
        gs1.dispose();
    	bufferedimage.flush();
    	ImageIO.write(bufferedimage,"png",new File("D:/djxsQrcode/idqrcode.png"));
	}
}
